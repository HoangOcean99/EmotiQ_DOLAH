  ...
  return (
    ...
    >
        <div style={{display: "flex", alignItems: "center"}}>
            <img style={{marginLeft: "3%"}} src="FooterBear.png" alt="FooterBear" width={"3%"}/>
            <div>
            ...
            <div>
                <p style={{color: "#543725", margin: "5px 0 0 400px", fontSize: "14px"}}> © 2025 EmotiQ. All rights reserved.</p>
            </div>
        </div>
    </div>
  );
